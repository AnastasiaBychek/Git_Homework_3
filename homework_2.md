...
Для того, чтобы слить две ветки, находясь в ветке, **в которую вы хотите произвести слияние**, в терминале в папке с созданным репозиторием необходимо  написать команду: *git merge <название ветки, которую вы хотите присоединить>*. Чаще всего слияние происходит автоматически, но иногда при слиянии могут возникнуть **конфликты**. В этом случае необходимо вручную получть желаемую версию файла и сделать коммит.
